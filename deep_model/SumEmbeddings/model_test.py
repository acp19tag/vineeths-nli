...
def SE_model_test(data, wandb):
    ...
    with open('./results/SumEmbeddings/SumEmbeddings.txt', 'w') as output_file:
    ...
    # plot_confusion_matrix(confusion_mtx, "SumEmbeddings", classes=range(2))
