...
def AE_model_train(data, wandb=None, static_config=None):
    
    from deep_model.AvgEmbeddings.parameters import EMBED_HIDDEN_SIZE, MAX_SEQ_LEN, ACTIVATION, DROPOUT, LEARNING_RATE, RHO, EPSILON, DECAY, BATCH_SIZE, TRAINING_EPOCHS, VALIDATION_SPLIT
