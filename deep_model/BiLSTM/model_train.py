...
def BL_model_train(data, wandb=None, static_config=None):
    
    from deep_model.BiLSTM.parameters import EMBED_HIDDEN_SIZE, MAX_SEQ_LEN, ACTIVATION, DROPOUT, LEARNING_RATE, RHO, EPSILON, DECAY, BATCH_SIZE, TRAINING_EPOCHS, VALIDATION_SPLIT, L2, LSTM_UNITS
    ...
    if wandb is not None and static_config is not None:
        ...
        L2 = static_config['l2']
        LSTM_UNITS = static_config['lstm_units']
